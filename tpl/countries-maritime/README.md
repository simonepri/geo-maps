...
[![World Boundaries](https://raw.githubusercontent.com/simonepri/geo-maps/master/media/geo-maps-countries-maritime.png)](http://geojson.io/#data=data:text/x-url,https://github.com/simonepri/geo-maps/releases/download/v{{version}}/countries-maritime-{{resolution}}.geo.json)
