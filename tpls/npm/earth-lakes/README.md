...
<p align="center">
  ...
  <a href="https://github.com/simonepri/geo-maps/blob/master/info/earth-lakes.md#downloads"><img src="https://img.shields.io/badge/resolution-{{resolution}}-f1c40f.svg" alt="map resolution" /></a>
  <a href="https://github.com/simonepri/geo-maps/blob/master/info/earth-lakes.md#downloads"><img src="http://img.badgesize.io/https://unpkg.com/@geo-maps/earth-lakes-{{resolution}}/map.geo.json" alt="map size" /></a>
  <a href="https://www.npmjs.com/package/@geo-maps/earth-lakes-{{resolution}}"><img src="https://img.shields.io/npm/dm/@geo-maps/earth-lakes-{{resolution}}.svg" alt="npm downloads" /></a>
  <a href="https://www.npmjs.com/package/@geo-maps/earth-lakes-{{resolution}}"><img src="https://img.shields.io/npm/v/@geo-maps/earth-lakes-{{resolution}}.svg" alt="npm version" /></a>
...
<br />
<p align="center">
  🗺 High Quality GeoJSON map of earth's lakes with {{resolution}} resolution.
</p>
<p align="center">
  <sub>
...
<p align="center">
  <a alt="World Boundaries" href="http://mapshaper.org/?files=https://unpkg.com/@geo-maps/earth-lakes-{{resolution}}/map.geo.json">
    <img src="https://raw.githubusercontent.com/simonepri/geo-maps/master/media/geo-maps-earth-lakes-shape.png" width ="49%"/>
  </a>
  <a alt="World Boundaries" href="http://geojson.io/#data=data:text/x-url,https://unpkg.com/@geo-maps/earth-lakes-{{resolution}}/map.geo.json">
...
## Install
```bash
$ npm install --save @geo-maps/earth-lakes-{{resolution}}
```

## Usage
```javascript
// Just require it and you are done!
const geoWorldLakes = require('@geo-maps/earth-lakes-{{resolution}}');
```
