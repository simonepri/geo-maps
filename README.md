...
<center>
  ...
  <a alt="World Boundaries" href="http://geojson.io/#data=data:text/x-url,http://geojson.io/#data=data:text/x-url,https://cdn.rawgit.com/simonepri/geo-maps/rework/preview/countries-maritime.geo.json">
